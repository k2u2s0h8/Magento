...
class Save extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $students = $objectManager->create('Detail\Form\Model\Form');
        
        if($_FILES['std_img']['name'] != NULL)
        {
        ...
        {
            $this->messageManager->addError( __('Please select image and add student image....') );
            $this->_redirect('*/*/detail');
        }
